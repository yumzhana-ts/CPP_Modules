...
/*   Updated: 2025/05/07 23:35:53 by ytsyrend         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class PmergeMe 
{
    private:
        ...
        int index;
    public:
        PmergeMe(typename PairN<N>::type v, int n, std::string l, int i);
        PmergeMe();
...
void swap_sections(std::vector<int> &vec, int position_a, int position_b, int element_length);
...
template<int N>
std::vector<PmergeMe<N> > create_pair_level_list(
    const std::vector<typename PairN<N>::type>& input);

template<int N>
void split_main_pend(const std::vector<PmergeMe<N> >& input,
                     std::vector<PmergeMe<N> >& main,
                     std::vector<PmergeMe<N> >& pend);
