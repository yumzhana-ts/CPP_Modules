...
int main() 
{
    ...
    int total_damage = 0;
    ClapTrap* obj1 = NULL;
    std::cout << "Choose player: ClapTrap(1), ScavTrap(2), FragTrap(3)" << std::endl;
    std::cin >> player;
    ...
    std::cout << BLUE << "ClapTrap, Scavtrap and Fragtrap, while traveling through the galaxy aboard their spacecraft," << std::endl;
    ...
    while(true)
    {
        ...
        switch (action) 
        {
            ...
            case 4:
                ...
                {
                    FragTrap* fragTrapPtr = (FragTrap*)(obj1);
