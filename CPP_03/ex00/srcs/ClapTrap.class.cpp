...
/*   Updated: 2024/07/13 03:11:59 by ytsyrend         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (DEBUG){ std::cout << GREEN << "[Constructor] Default Constructor called" << RESET_COLOR << std::endl;}
}

ClapTrap::ClapTrap(const ClapTrap& src) 
{
    if (DEBUG){std::cout << GREEN << "[Constructor] Copy Constructor called" << RESET_COLOR << std::endl;}
    *this = src;
}
...
{
    if (DEBUG){std::cout << GREEN << "[Destructor] Destructor called" << RESET_COLOR << std::endl;}
}
...
void ClapTrap::attack(const std::string& target)
{
    ...
    {
        std::cout << BLUE << this-> name << " attacks " << target << ", causing " << this->attack_damage << " points of damage!" << RESET_COLOR << std::endl;
        this->energy_points--;
    }
}
void ClapTrap::take_damage(unsigned int amount)
{
    ...
    else
    {
        ...
        std::cout << this->name << " was attacked, taking " << amount << " points of damage and left breathless by the impact." RESET_COLOR << std::endl;
...
{    
    ...
    else
    {
        ...
        if (this->hit_points > 10)
            this->hit_points = 10;
        std::cout << BLUE << "ClapTrap " << this->name <<"'s sensors activated.";
